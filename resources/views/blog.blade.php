...
@section('container')
    ...
    <h1 class="mb-4 border-bottom pb-3 text-center">{{ $title }}</h1>
        ...
        <div class="col-md-6">
            <form action="/blog">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-dark" type="submit" id="button-search">Search</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card mb-3">
            ...
            @if ($posts[0]->image)
                <div style="max-height: 400px; overflow:hidden;">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" alt="{{ $posts[0]->category->name }}" class="img-fluid" style="width: 100%; height: 100%;">
                </div>
            @else
                <img src="https://picsum.photos/seed/picsum/1200/300" class="card-img-top" alt="{{ $posts[0]->category->name }}">
            @endif
            ...
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        @else
                            <img src="https://picsum.photos/id/237/400/300" class="card-img-top" alt="{{ $post->category->name }}">
                        @endif
                        <div class="card-body">
